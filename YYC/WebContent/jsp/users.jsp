...
<body scroll="no">
<%
List<Emp> userlist=(List<Emp>)session.getAttribute("userlist");
if(userlist==null){
%>
...
<tr>
<td width="30%" >用户名：</td>
<td style="width:40%"><input type="text" name="username" size="30%" style="width:100%;"></td>
<td style="width:1%">&nbsp;</td>
<td style="width:1%">&nbsp;</td>
<td style="width:1%">&nbsp;</td>
...
<button style="width:30%" onClick="addUser()">新增用户</button>
...
<th width="25%"><span>用户名</span></th>
<th width="20%"><span>密码</span></th>
<th width="30%"><span>注册时间</span></th>
<th width="20%"><span>权限</span></th>
</tr>
</thead>
<tbody>
<%
...
<table width="150%" >
<tr><td style="cursor:hand;">
<a href="http://localhost:8080/YYC/UserFengye?curPage=1">第一页</a>&nbsp;&nbsp;&nbsp;
<a href="http://localhost:8080/YYC/UserFengye?curPage=${pageUser.curPage-1}">上一页</a>&nbsp;&nbsp;&nbsp;
<a href="http://localhost:8080/YYC/UserFengye?curPage=${pageUser.curPage+1}">下一页</a>&nbsp;&nbsp;&nbsp;
<a href="http://localhost:8080/YYC/UserFengye?curPage=${pageUser.totalPage}">最后一页</a>
</td></tr>
</table>
</table>
</div>
